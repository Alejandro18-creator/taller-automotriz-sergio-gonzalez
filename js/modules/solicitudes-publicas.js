...
const SolicitudesPublicasModule = {
      ...
      <div class="solicitudes-container">
        ...
        <table class="table">
          ...
          <tbody id="solicitudesBody">
            <tr>
              <td colspan="9" style="text-align: center; padding: 20px;">Cargando solicitudes...</td>
            </tr>
          </tbody>
        </table>
      </div>
  ...
  async cargarSolicitudes() {
    ...
    tbody.innerHTML = `
      <tr>
        <td colspan="9" style="text-align: center; padding: 20px;">Consultando Supabase...</td>
      </tr>
    `;
    ...
    try {
      ...
      if (!data || data.length === 0) {
        tbody.innerHTML = `
          <tr>
            <td colspan="9" style="text-align: center; padding: 20px;">Sin solicitudes registradas</td>
          </tr>
        `;
        return;
      }
      ...
      tbody.innerHTML = `
        <tr>
          <td colspan="9" style="text-align: center; padding: 20px;">No se pudo cargar la información</td>
        </tr>
      `;
